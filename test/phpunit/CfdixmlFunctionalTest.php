...
/**
 * \file    test/phpunit/CfdixmlFunctionalTest.php
 * \ingroup cfdixml
 ...
 * @package Testcfdixml
 */
class CfdixmlFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	{
		$this->url('/custom/cfdixml/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('cfdixml/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/cfdixml/admin/about.php');
		$this->authenticate();
		return $this->assertContains('cfdixml/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('cfdixmlwidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modCfdixml_CfdixmlTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modCfdixml_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
