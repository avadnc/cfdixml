...
llxHeader("", $langs->trans("CfdixmlArea"));

print load_fiche_titre($langs->trans("CfdixmlArea"), '', 'cfdixml.png@cfdixml');
...
// Draft MyObject
if (! empty($conf->cfdixml->enabled) && $user->rights->cfdixml->read)
{
	$langs->load("orders");
...
if (! empty($conf->cfdixml->enabled) && $user->rights->cfdixml->read)
{
	...
	$sql.= " FROM ".MAIN_DB_PREFIX."cfdixml_myobject as s";
	//if (! $user->rights->societe->client->voir && ! $socid) $sql.= ", ".MAIN_DB_PREFIX."societe_commerciaux as sc";
