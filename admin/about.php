...
// Translations
$langs->loadLangs(array("errors", "admin", "cfdixml@cfdixml"));
...
print dol_get_fiche_head($head, 'about', $langs->trans($page_name), 0, 'cfdixml@cfdixml');

dol_include_once('/cfdixml/core/modules/modCfdixml.class.php');
$tmpmodule = new modCfdixml($db);
