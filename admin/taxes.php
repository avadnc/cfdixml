...
if($action == 'save'){
	...
	// }
	if(GETPOST('resico_tax')) dolibarr_set_const($db, "CFDIXML_RESICO_TAX", GETPOST('resico_tax'), 'chaine', 1, '', $conf->entity);
...
print load_fiche_titre($langs->trans($page_name), $linkback, 'title_setup_tax');

// Configuration header
$head = cfdixmlAdminPrepareHead();
print dol_get_fiche_head($head, 'taxes', $langs->trans($page_name), -1, "cfdixml@cfdixml");
...
print '<tr><td>Impuesto Resico</td><td><input class="maxwidth500 widthcentpercentminusx" type="text" name="resico_tax" id="resico_tax" value="'.$conf->global->CFDIXML_RESICO_TAX.'"></td></tr>';
